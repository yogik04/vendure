...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zBoDUyhIZ2-/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: _AQcRXCHxH7/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: xYVnMnnxQ3S/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aZxEd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon2Icon
                className={classNames(projectcss.all, sty.svg__h1BE)}
                role={"img"}
              />
            ),
